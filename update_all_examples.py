...
# Find all occurrences of the example text container
pattern = re.compile(r'(<div style="color: #0891b2; font-weight: 700; font-size: 1.05rem; margin-bottom: 10px; display: flex; align-items: center; gap: 8px;"><i class="fa-solid fa-book-open"></i> VÍ DỤ MINH HOẠ [12]</div>\s*<div style="background: #f8fafc; border-left: 4px solid #cbd5e1; border-radius: 8px; padding: 14px; margin-bottom: 14px; font-size: 1.05rem; line-height: 1.7; color: #1e293b;">)(.*?)(</div>)', re.DOTALL)
