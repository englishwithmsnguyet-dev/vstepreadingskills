...
function highlightQuestionKeywords(qText) {
    ...
    const keywords = [
        ...
        "reason for", "reason", "cause of", "cause", "why was", "originally", "originally built",
        "ability", "share with", "share", "only a few", "few", "likely"
    ];
...
function formatTheoryHTML(container, discardExample = true) {
    ...
    children.forEach(el => {
        ...
        if (discardExample && (trimmedUpper === 'VÍ DỤ MINH HỌA' || trimmedUpper === 'VÍ DỤ MINH HOẠ' || trimmedUpper === 'VÍ DỤ MINH HỌA:' || trimmedUpper === 'VÍ DỤ MINH HOẠ:')) {
